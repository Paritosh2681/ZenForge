...
export default function AttentionMonitor() {
  ...
  return (
    <div className="h-full overflow-y-auto bg-[rgb(var(--bg-base))]">
      {/* Header */}
      <div className="bg-gradient-to-r from-[rgb(var(--bg-elevated))] to-[rgb(var(--bg-surface))] border-b border-[#22C55E]/20 text-white p-4 sm:p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl sm:text-3xl font-display font-bold mb-2 text-white">Focus & Attention Monitor</h1>
          <p className="text-[#22C55E] text-sm sm:text-base font-mono">Real-time attention tracking using AI-powered face analysis</p>
            ...
            <button
              ...
              className={`px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold transition-all flex items-center gap-2 ${
                isActive
                  ...
                  : 'bg-[#22C55E] hover:bg-[#22C55E]/90 text-[#0D0D0D] shadow-[0_0_15px_rgba(34,197,94,0.3)]'
              }`}
            >
              {isActive ? (
                <>
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        {/* Status Message */}
        {!error && (
          <div className="gc-card p-4 border-l-4 border-[#22C55E]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="gc-card p-4 flex items-center gap-3">
            <Camera className={`w-6 h-6 ${cameraPermission ? 'text-[#22C55E]' : 'text-red-400'}`} />
            <div>
              <div className="text-sm font-medium text-white">Camera</div>
              <div className={`text-xs font-mono ${
                cameraPermission === null ? 'text-amber-400' : 
                cameraPermission ? 'text-[#22C55E]' : 'text-red-400'
              }`}>
          ...
          <div className="gc-card p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className={`text-xs font-mono ${
                ...
                isBackendReachable ? 'text-[#22C55E]' : 'text-red-400'
              }`}>
          ...
          <div className="gc-card p-4 flex items-center gap-3">
            <Eye className={`w-6 h-6 ${
              !metrics || !metrics.face_detected ? 'text-gray-400' : 'text-[#22C55E]'
            }`} />
            <div>
        ...
        {/* Instructions Panel */}
        <div className="lg:col-span-2 gc-card p-6 bg-gradient-to-br from-[#22C55E]/10 to-transparent border-[#22C55E]/30">
          <h3 className="text-lg font-semibold text-[#22C55E] mb-3 flex items-center gap-2">
            <AlertCircle className="w-5 h-5" />
            How it works:
          </h3>
