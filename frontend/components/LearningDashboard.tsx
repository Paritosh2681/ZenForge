    ...
    <div className="h-full overflow-y-auto bg-[rgb(var(--bg-base))]">
      ...
      <div className="bg-gradient-to-r from-[rgb(var(--bg-elevated))] to-[rgb(var(--bg-surface))] border-b border-[#22C55E]/20 text-white p-4 sm:p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#22C55E] text-sm sm:text-base font-mono">Track your progress and mastery</p>
            ...
            {[7, 30, 90].map((days) => (
              <button
                ...
                className={`px-3 sm:px-4 py-2 rounded-lg font-medium transition-colors text-sm sm:text-base ${
                  selectedPeriod === days
                    ? 'bg-[#22C55E] text-[#0D0D0D] font-bold shadow-[0_0_10px_rgba(34,197,94,0.3)]'
                    : 'bg-white/10 hover:bg-[#22C55E]/20 text-[#22C55E] border border-[#22C55E]/30'
                }`}
              >
                {days} days
              </button>
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        {recommendations && recommendations.study_tips.length > 0 && (
          <div className="gc-card p-6 border border-[#22C55E]/20">
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {recommendations.topics_to_review.slice(0, 5).map((topic, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1 bg-[#22C55E]/20 text-[#22C55E] text-sm rounded-full border border-[#22C55E]/30"
                    >
                      {topic.name}
                    </span>
                  ))}
          ...
          {quizHistory.length === 0 ? (
            ...
            <div className="space-y-3">
              {quizHistory.map((quiz) => (
                <div
                  key={quiz.session_id}
                  className="flex items-center justify-between p-4 border border-[#22C55E]/20 rounded-lg hover:bg-[rgb(var(--bg-elevated))]/50 transition-colors bg-[rgb(var(--bg-surface))]"
                >
